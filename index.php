...
<li>Durch Ihr Bild d&uuml;rfen die Privatsph‰re und Rechte anderer nicht verletzt werden.</li>
<li>Keine pornografischen, Bilder, bzw. Bilder die anderweitig gegen Deutsche Gesetze verstoﬂen.</li>
...
$contentarray3 = array(
"BILDPREV" 		=> '<a href="'.$bildlink_direkt.'" target="_blank">'.$thumbnail_img.'</a> Ein klick auf das Vorschaubild ruft die gro&szlig;e Version auf.',
...
// ################################################################ //
return array($breite, $hoehe, $newfilesize);
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
// Wartungsfunktionen
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
