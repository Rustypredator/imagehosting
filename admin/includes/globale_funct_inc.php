...
class template
{
     ...
     * @param integer $no_replace noreplace?
     * 
     * @return void
     */
 ...
 * @param integer $maximal   Maximale Eingabelaenge, bei Ueberschreitung kuerzen
 * @param integer $regextype Numerischer Wert fuer Regexanweisung, wenn leer wird 1 angewendet
 * 
 * @return void
 */
 ...
 *
 * @param integer $art    1-4 -> Buchstaben/Zahlen - Großbuchstaben - nur Zahlen - uniqid mit md5
 * @param integer $von    Länge der Zeichenkette
 * @param integer $bis    Länge der Zeichenkette
 ...
 *
 * @param integer $zeilen          anzahl der Zeilen
 * @param integer $seite           aktuelle Seite
 * @param integer $pro_seite       anzahl Pro seite
 * @param string  $url             URL
 * @param integer $show_pageinfo   0|1 anzeigen oder nicht
 * @param integer $linkanzahl      anzahl
 * @param integer $show_pageselect show select
 * 
 * @return void
 */
