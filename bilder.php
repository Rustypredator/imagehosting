...
$bildstatistik = '<ul>
<li>Bild hochgeladen am: '.$picdata['uploaddate'].'</li>
<li>Aufrufe dieses Bildes: '.($trstat2['anz']+1).'</li>
<li>Traffic dieses Bildes: '.dateigroesse($trstat1['gesamttraffic']+$picdata['up_bytesize']).'</li>
<li>Dteigr&ouml;&szlig;e dieses Bildes: '.dateigroesse($picdata['up_bytesize']).'</li>
</ul>';
...
$contentarray2 = array(
"BILDHTML" 		=> '<img src="img/'.$picdata['up_vz'].'/'.$picdata['up_picname'].'.'.$picdata['up_endung'].'" alt="Bild" width="'.$picdata['up_width'].'" height="'.$picdata['up_height'].'" border="0" align="left" title="Orginalbildname von: '.$picdata['up_orginalname'].'" style="padding: 5px;">',
"BILDSTAT" 		=> $bildstatistik
); 
